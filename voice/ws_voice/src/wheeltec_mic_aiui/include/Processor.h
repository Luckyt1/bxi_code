...
#define CURRENT_PATH "/home/tang/voice/ws_voice/src/wheeltec_mic_aiui"
...
std::mutex tts_mutex;                   // TTS互斥锁
std::condition_variable tts_cv;         // TTS条件变量
std::queue<std::string> tts_queue;      // TTS任务队列
bool is_tts_playing = false;            // 是否正在播放TTS
