...
#include "wheeltec_mic_msg/srv/detail/get_offline_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = wheeltec_mic_msg::srv::GetOfflineResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wheeltec_mic_msg::srv::GetOfflineResult_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<wheeltec_mic_msg::srv::GetOfflineResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetOfflineResult_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wheeltec_mic_msg::srv::GetOfflineResult_Request *>(
...
static size_t _GetOfflineResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetOfflineResult_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetOfflineResult_Request__callbacks = {
...
static rosidl_message_type_support_t _GetOfflineResult_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOfflineResult_Request__callbacks,
...
{
  return &wheeltec_mic_msg::srv::typesupport_fastrtps_cpp::_GetOfflineResult_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = wheeltec_mic_msg::srv::GetOfflineResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const wheeltec_mic_msg::srv::GetOfflineResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<wheeltec_mic_msg::srv::GetOfflineResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetOfflineResult_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const wheeltec_mic_msg::srv::GetOfflineResult_Response *>(
...
static size_t _GetOfflineResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetOfflineResult_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetOfflineResult_Response__callbacks = {
  "wheeltec_mic_msg::srv",
...
static rosidl_message_type_support_t _GetOfflineResult_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOfflineResult_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &wheeltec_mic_msg::srv::typesupport_fastrtps_cpp::_GetOfflineResult_Response__handle;
}
...
static service_type_support_callbacks_t _GetOfflineResult__callbacks = {
  "wheeltec_mic_msg::srv",
  "GetOfflineResult",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wheeltec_mic_msg, srv, GetOfflineResult_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wheeltec_mic_msg, srv, GetOfflineResult_Response)(),
...
static rosidl_service_type_support_t _GetOfflineResult__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetOfflineResult__callbacks,
...
{
  return &wheeltec_mic_msg::srv::typesupport_fastrtps_cpp::_GetOfflineResult__handle;
}
