...
public:
    CmdVelToMotion() : Node("cmd_vel_to_motion") {
        ...
        this->declare_parameter("filter_alpha_xy", 0.5);      // x/y 滤波系数 0.1
        this->declare_parameter("filter_alpha_yaw", 0.5);     // yaw 滤波系数 0.1
        this->declare_parameter("dead_zone", 0.03);            // 死区 0.05 m/s
